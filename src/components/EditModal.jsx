  ...
  return (
    <div className="modal-overlay z-5 fixed top-0 left-0 w-100 h-100 bg-black-40 bg-blur flex justify-center align-center">
      <div className="modal-content">
        ...
        <div className="mt2">
          <button className="mr2 glow-bg ba b--white bw1 br4 fw6 o-50 glow" onClick={onSave}>Save</button>
          <button className="glow-bg ba b--white bw1 br4 fw6 o-50 glow" onClick={onClose}>Close</button>
        </div>
      </div>
    </div>
  );
